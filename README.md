...
| ----------------------- | --------------- | ------------ | ----------------- | -------------------- | ------------------- | ------------------------------------------------------- |
| JavaScript • TypeScript • Python (AI Agents)  | Next.js • React • Angular | React Native | Node.js • Express • Spring Boot | MongoDB • PostgreSQL • MySQL | Ethereum • Solidity | Docker • Kubernetes • Vagrant • Terraform • Git • Linux |
